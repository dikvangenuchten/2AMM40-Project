...
class MultiBoxLoss(nn.Module):
    ...
    def __init__(
        ...
        self.priors_xy = box_utils.cxcy_to_xy(priors_cxcy)
    ...
    def forward(self, predicted_locs, predicted_scores, boxes, labels):
        ...
        for i in range(batch_size):
            ...
            overlap = box_utils.find_jaccard_overlap(
            ...
            true_locs[i] = box_utils.cxcy_to_gcxgcy(
                box_utils.xy_to_cxcy(boxes[i][object_for_each_prior]), self.priors_cxcy
            )  # (8732, 4)
